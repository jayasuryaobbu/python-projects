...
model = load_model('fingers.hdf5')  # predefined image models

cap = cv2.VideoCapture(0)  # startcapturing video
...
while True:
    ...
    show = frame[50:200, 400:550]  # color video frame angle
    frame = cv2.blur(frame, (2, 2))
    gray = cv2.cvtColor(frame, cv2.COLOR_BGR2GRAY)  # color conversion

    gray = gray[50:200, 400:550]  # gray video frame angle
